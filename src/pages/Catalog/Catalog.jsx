...
export default function Catalog() {
    ...
    const [priceCar, setPriceCar] = useLocalStorage("priceCarCatalog", "");
    const [mileageFrom, setMileageFrom] = useLocalStorage(
        "mileageFromCatalog",
        ""
    );
    const [mileageTo, setMileageTo] = useLocalStorage("mileageToCatalog", "");
    ...
    const [filteredCars, setFilteredCars] = useState(carsFromRedux);
    ...
    const fetchCarsFilter = () => {
        let filteredResult = [...carsFromRedux];
